<nav class="sidebar sidebar-offcanvas active" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('transkrip_nilai'); ?>"><i class="mdi mdi-newspaper menu-icon"></i><span class="menu-title">Transkrip Nilai</a></li>
  </ul>
</nav>

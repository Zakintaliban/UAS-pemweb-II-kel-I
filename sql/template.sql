...
CREATE TABLE Taruna(
    ...
    Foto BLOB,
    PRIMARY KEY(ID),
    FOREIGN KEY (Tempat_Lahir) REFERENCES Kota(ID) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (Program_Studi) REFERENCES Program_Studi(ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Ijazah(
    ...
    PRIMARY KEY(ID),
    FOREIGN KEY (Taruna) REFERENCES Taruna(ID) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (Program_Studi) REFERENCES Program_Studi(ID) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (Wakil_Direktur) REFERENCES Pejabat(ID) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (Direktur) REFERENCES Pejabat(ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Nilai(
    ...
    PRIMARY KEY(ID),
    FOREIGN KEY (Taruna) REFERENCES Taruna(ID) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (Matakuliah) REFERENCES Matakuliah(ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Transkrip_Nilai(
    ...
    PRIMARY KEY(ID),
    FOREIGN KEY (Taruna) REFERENCES Taruna(ID) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (Ijazah) REFERENCES Ijazah(ID) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (Program_Studi) REFERENCES Program_Studi(ID) ON DELETE CASCADE ON UPDATE CASCADE
);
